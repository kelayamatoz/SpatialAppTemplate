  ...
  def main(args: Array[String]): Unit = {
    ...
    Accel {
      Foreach (32 by 1 par 1, 96 by 32 par 1, 32 by 16) { (idx0, idx1, idx2) =>
        ...
        if (idx2 == I32(0)){ x_24_ConCat_SRAM load x_24_ConCat_DRAM(idx0 :: idx0 + 1, idx1 :: idx1 + 32 par 1) }
        val x_25_ConCat_SRAM = SRAM[T](32)
        if (idx2 == I32(0)){ x_25_ConCat_SRAM load x_25_ConCat_DRAM(idx1 :: idx1 + 32 par 1) }
        ...
        if (idx0 == 31) { x_6_Tensor_L15_DRAM(0 :: 32 par 1) store x_6_Tensor_L15_SRAM }
      }
    }
